...
const KeyValueDetail = ({ ele, index, title, deleteElement , updateData}) => {
    return (
        <div
            ...
            {ele.dataType !== "description" ? (
                <fieldset className="flex flex-col md:flex-row gap-2">
                    ...
                    <input
                        ...
                        className="p-2 bg-base-300 w-full"
                    />
                    <select name={`${ele._id}-type`} className="select select-neutral w-36 outline-0 focus:outline-0">
